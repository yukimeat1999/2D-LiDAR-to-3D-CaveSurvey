...
void PointCloudView(const pcl::PointCloud<pcl::PointXYZ>::Ptr PointCloud, const std::string& PortName, const pcl::PointXYZ Point);
  ...
  : public RTC::DataFlowComponentBase
{
 ...
 protected:
  ...
  PointCloudTypes::PointCloud m_analyses_PointCloud;
  /*!
   */
  RTC::InPort<PointCloudTypes::PointCloud> m_analyses_PointCloudIn;
